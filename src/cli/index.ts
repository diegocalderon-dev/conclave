...
RUN OPTIONS:
  -t, --task <text>            Task or question to deliberate (prompted in a TTY; Enter submits, Shift+Enter inserts a new line)
...
async function resolveTask(
  ...
  const intro = invokedWithoutCommand
    ? "conclave interactive mode\nEnter a task to deliberate. Press Shift+Enter for a new line, Enter to submit, or Ctrl+C to cancel.\n\n"
    : "No task provided.\nEnter a task to deliberate. Press Shift+Enter for a new line, Enter to submit, or Ctrl+C to cancel.\n\n";
